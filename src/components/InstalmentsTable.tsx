...
import { INSTALMENTS_DATA } from '@/lib/data';

const total = INSTALMENTS_DATA.reduce((s, r) => s + r.amount, 0);
...
export default function InstalmentsTable() {
  return (
    ...
    >
      ...
      <p className="text-slate-500 text-xs mt-0.5 mb-4">Next 10 scheduled payments</p>
